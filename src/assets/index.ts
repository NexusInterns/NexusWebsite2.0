...
const coursesList = [
    ...
    new Course("Windows Server 2019:", "Administration Automation", "using Powershell", "CCNA200-301", "Cisco certification is the edge you need to jump-start your IT career", "FREE for Out-of-School Youth", 5),
];
